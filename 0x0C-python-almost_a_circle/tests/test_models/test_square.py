...
class test_square(unittest.TestCase):
    ...
    def test_json_string(self):
            ...
            sx = {'id': 2089, 'size': 10}
            sy = {'size': 7, 'id': 2712}
            self.assertEqual(list_input[0], sx)
            self.assertEqual(list_input[1], sy)
...
class TestSquare(unittest.TestCase):
    ...
    def test_10_0(self):
        ...
        sx = Square(5, 3, 4)
        self.assertEqual(sx.height, 5)
        self.assertEqual(sx.width, 5)
        self.assertEqual(sx.x, 3)
        self.assertEqual(sx.y, 4)
        self.assertEqual(sx.id, 2)

    def test_10_1(self):
        """Test __str__ representation."""

        sx = Square(9, 4, 5, 6)
        self.assertEqual(str(sx), "[Square] (6) 4/5 - 9")

    def test_10_2(self):
        """Test Square class: check for inheritance."""

        sx = Square(6)
        self.assertTrue(isinstance(sx, Rectangle))
        self.assertTrue(issubclass(Square, Rectangle))
        self.assertFalse(isinstance(Square, Rectangle))
        self.assertTrue(isinstance(sx, Base))
    ...
    def test_10_4(self):
        ...
        sx = Square(9)
        self.assertEqual(sx.area(), 81)
        sy = Square(4, 1, 2, 5)
        sy.update(7)
        self.assertEqual(sy.id, 7)
        f = io.StringIO()
        s3 = Square(4)
    ...
    def test_11_0(self):
        ...
        sx = Square(8)
        self.assertEqual(sx.size, 8)
        sy = Square(9, 8, 7, 2)
        self.assertEqual(sy.size, 9)
    ...
    def test_12_0(self):
        ...
        sx = Square(5)
        sx.update(10)
        self.assertEqual(sx.id, 10)
        sx.update(x=12)
        self.assertEqual(sx.x, 12)
        sx.update(size=7, id=89, y=1)
        self.assertEqual(sx.size, 7)
        self.assertEqual(sx.id, 89)
        self.assertEqual(sx.y, 1)
        sx.update()
        self.assertEqual(sx.size, 7)
        self.assertEqual(sx.id, 89)
        self.assertEqual(sx.y, 1)
    ...
    def test_14_0(self):
        ...
        self.assertEqual(len(sx_dictionary), len(s_dictionary))
        self.assertEqual(type(sx_dictionary), dict)
        sy = Square(1, 1)
        sy.update(**sx_dictionary)
        sy_dictionary = sy.to_dictionary()
        self.assertEqual(len(sx_dictionary), len(sy_dictionary))
        self.assertEqual(type(sy_dictionary), dict)
        self.assertFalse(sx == sy)
